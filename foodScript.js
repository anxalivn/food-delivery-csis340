...
$(document).ready(function () {
    $.getJSON(api_foods_url, function (foods) {
        ...
        $.each(foods, function (key, value) {
            ...
            foodData += '<td> <div class="img-container"> <img src="Images/'+value.foodImage + ' "alt="" border=3 height=100 width=100 class="img" /><button class="bag-btn" data-id="1"> <i class="fas fa-shopping-cart"></i>Add to bag</button></div></td>';
            foodData += '</tr>';
        });
