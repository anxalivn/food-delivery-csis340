...
$(document).ready(function () {
    $.getJSON(api_foods_url, function (foods) {
        ...
        $.each(foods, function (key, value) {
            ...
            foodData += '<td> <div class="img-container"> <img src="Images/' + value.foodImage + ' "alt="" border=3 height=100 width=100 class="img" /> <a class="fas-fa shopping-cart" href="#">Add Cart</a> </div></td>';
            foodData += '</tr>';
        });
